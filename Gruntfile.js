module.exports = function(grunt) {
    grunt.initConfig({
        ...
        copy: {
            ia32: {
                files: [{src: 'build/Release/win_rw.node', dest: 'lib/win_rw_' + process.platform + '_ia32.node'}]
            },
            x64: {
                files: [{src: 'build/Release/win_rw.node', dest: 'lib/win_rw_' + process.platform + '_x64.node'}]
            }
        }
    });
